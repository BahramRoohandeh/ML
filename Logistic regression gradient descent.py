# Full mplemantion of logistic Regression 
...
def compute_cost(x, y, w, b):
    ...
    for i in range(m):
        ...
        loss_i =  (-y[i] * np.log(f_x_i))-((1-y[i])*(np.log(1-f_x_i)))
        loss = loss + loss_i
    print(loss/m)
    return loss / m
...
w , b =gradient_descent(X_train, y_train, 0.01 * (np.random.rand(2) - 0.5), -8, 0.001, 10000, compute_gradient)



# step 5: predicting answers
def predict(x, w, b): 
